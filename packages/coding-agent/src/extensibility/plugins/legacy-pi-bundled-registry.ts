...
import * as bundledPiCodingAgentEditFailureMessage from "@oh-my-pi/pi-coding-agent/edit/failure-message";
...
export const BUNDLED_PI_REGISTRY: Readonly<Record<string, Readonly<Record<string, unknown>>>> = {
	...
	"@oh-my-pi/pi-coding-agent/edit/failure-message": bundledPiCodingAgentEditFailureMessage as unknown as Readonly<
		Record<string, unknown>
	>,
